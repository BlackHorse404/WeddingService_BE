...
namespace WeddingsWebsite.Controllers
{
    public class SanPhamController : Controller
    {
        ...
        public PartialViewResult ContentOrderedPartial()
        {
            List<GioHang> lGH = Session["giohang"] as List<GioHang>;
            if(lGH != null)
            {
        ...
        public ActionResult StateOrdered(FormCollection f)
        {
            if(f != null)
            {
                //string name = f["fullname"].ToString();
                //string telephone = f["Telephone"].ToString();
                //string mail = f["email"].ToString();
                //string address = f["Address"].ToString();
                //InfoOrder t = new InfoOrder(name, telephone, mail, address);
                //db..InsertOnSubmit(t);
                //db.SubmitChanges();
            }
